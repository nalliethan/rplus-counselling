...
const resources = {
  en: {
    translation: {
      "nav_home": "Home",
      "nav_aboutR": "About RT Possibilities",
      ...
      "hero_offline": "In-Person — Seremban 2",
      "hero_book_now": "Book Now",
      "about_title": "RT Possibilities",
      ...
      "about_paragraph_2": "We believe there is always room to make space for our experiences, reconnect with what matters, and move towards new possibilities.",
      ...
      "session_location": "In-Person — Seremban 2",
      "session_hours": "Consultation Hours",
      "session_operation_hours1": "Monday - Friday: 9:00am - 5:00pm",
      "session_operation_hours2": "",
      ...
      "book_note_lists": [
        ...
        "RT Possibilities does not provide immediate crisis intervention. If you are experiencing a psychological emergency, please contact the following 24-hour helplines or visit the nearest hospital emergency department:"
      ],
      "book_hotlines": [
  ...
  zh: {
    translation: {
      "nav_home": "主页",
      "nav_aboutR": "关于 RT Possibilities",
      "nav_services": "服务项目",
      ...
      "hero_online": "线上",
      "hero_offline": "实体 — 芙蓉新城 S2",
      "hero_book_now": "欢迎联系",
      "about_title": "RT Possibilities 心理辅导与咨询",
      ...
      "about_paragraph_2": "我们相信，每个人都可以在接纳自身经历的同时，重新连接对自己重要的事物，并走向更多成长、改变与可能性 (Possibilities)。",
      "services_title": "服务项目",
      ...
      "session_online": "线上",
      "session_location": "实体 — 芙蓉新城 S2",
      "session_hours": "辅导与咨询时段",
      "session_operation_hours1": "星期一至星期五: 上午9:00 - 下午5:00",
      "session_operation_hours2": "",
      ...
      "book_note_lists": [
        ...
        "RT Possibilities 心理辅导与咨询并不提供即时危机干预服务。如遇紧急心理危机，请即刻致电以下24小时热线或前往邻近医院急诊部。"
      ],
      "book_hotlines": [
        "Befrienders: 03-7627 2929",
        "Talian Kasih: 15999",
