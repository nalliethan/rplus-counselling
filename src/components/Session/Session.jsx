...
const Session = () => {
  ...
  return (
    <div id="session" className='min-h-[80vh] relative bg-linear-to-r from-[#ffeddb] to-[#ffffff] text-[#55675b] text-lg sm:text-2xl flex items-center justify-center gap-14 md:gap-20 lg:gap-28 flex-col md:flex-row p-8 md:py-20 lg:py-38 px-[10%]'>
